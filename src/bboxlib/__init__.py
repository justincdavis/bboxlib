...
---------
set_log_level
    Set the log level for the bboxlib package.
enable_jit
...
level = os.getenv("BBOXLIB_LOG_LEVEL")
_setup_logger(level)
...
class _FLAGS:
    """
    Class for storing flags for bboxlib.
...
_log.info(f"Initialized bboxlib with version {__version__}")
